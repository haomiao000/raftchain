...
func newBlock(db *gorm.DB, opts ...gen.DOOption) block {
	...
	_block.Height = field.NewInt64(tableName, "height")
	_block.Term = field.NewInt64(tableName, "term")
	_block.Hash = field.NewString(tableName, "hash")
	_block.PrevHash = field.NewString(tableName, "prev_hash")
	_block.Timestamp = field.NewTime(tableName, "timestamp")
	_block.ProposerNodeID = field.NewInt32(tableName, "proposer_node_id")
	_block.Data = field.NewBytes(tableName, "data")
...
type block struct {
	...
	ALL            field.Asterisk
	ID             field.Int64
	Height         field.Int64  // 区块高度
	Term           field.Int64  // Raft任期
	Hash           field.String // 区块哈希
	PrevHash       field.String // 前一区块哈希
	Timestamp      field.Time   // 区块时间戳
	ProposerNodeID field.Int32  // 提议该区块的节点ID
	Data           field.Bytes  // 区块数据（通常是序列化后的交易列表）
...
func (b *block) updateTableName(table string) *block {
	...
	b.Height = field.NewInt64(table, "height")
	b.Term = field.NewInt64(table, "term")
	b.Hash = field.NewString(table, "hash")
	b.PrevHash = field.NewString(table, "prev_hash")
	b.Timestamp = field.NewTime(table, "timestamp")
	b.ProposerNodeID = field.NewInt32(table, "proposer_node_id")
	b.Data = field.NewBytes(table, "data")
...
func (b *block) fillFieldMap() {
	...
	b.fieldMap["id"] = b.ID
	b.fieldMap["height"] = b.Height
	b.fieldMap["term"] = b.Term
	b.fieldMap["hash"] = b.Hash
	b.fieldMap["prev_hash"] = b.PrevHash
	b.fieldMap["timestamp"] = b.Timestamp
	b.fieldMap["proposer_node_id"] = b.ProposerNodeID
