...
import (
	...
	"github.com/haomiao000/raftchain/backend/library/model"
)
...
func newNode(db *gorm.DB, opts ...gen.DOOption) node {
	...
	_node.Role = field.NewString(tableName, "role")
	_node.Term = field.NewInt32(tableName, "term")
	_node.CommitIndex = field.NewInt32(tableName, "commit_index")
	_node.LastApplied = field.NewInt32(tableName, "last_applied")
	_node.Status = field.NewString(tableName, "status")
	_node.LastHeartbeat = field.NewTime(tableName, "last_heartbeat")
...
type node struct {
	...
	ALL           field.Asterisk
	ID            field.Int64  // 主键ID
	NodeID        field.Int32  // Raft节点ID
	Address       field.String // 节点地址
	Role          field.String // 节点角色 (Leader, Follower, Candidate)
	Term          field.Int32  // 当前任期
	CommitIndex   field.Int32  // 已提交日志索引
	LastApplied   field.Int32  // 最后应用日志索引
	Status        field.String // 节点状态 (active, inactive)
	LastHeartbeat field.Time   // 最后心跳时间
...
func (n *node) updateTableName(table string) *node {
	...
	n.Role = field.NewString(table, "role")
	n.Term = field.NewInt32(table, "term")
	n.CommitIndex = field.NewInt32(table, "commit_index")
	n.LastApplied = field.NewInt32(table, "last_applied")
	n.Status = field.NewString(table, "status")
	n.LastHeartbeat = field.NewTime(table, "last_heartbeat")
...
func (n *node) fillFieldMap() {
	...
	n.fieldMap["term"] = n.Term
	n.fieldMap["commit_index"] = n.CommitIndex
	n.fieldMap["last_applied"] = n.LastApplied
	n.fieldMap["status"] = n.Status
	n.fieldMap["last_heartbeat"] = n.LastHeartbeat
